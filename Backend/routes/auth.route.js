...
import {  authCheck, createBlog, deleteBlog, getUserBlogs, login, logout, signup, updateBlog, updateBlogStatus } from '../controllers/auth.controller.js'
...
router.put("/status-blog/:id",protectRoute, updateBlogStatus)
